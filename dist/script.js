...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.on = function (eventName, calllBack) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.off = function (eventName, calllBack) {
  if (!eventName || !calllBack) {
    return this;
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttribute = function (attributeName, value) {
  for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.active').removeAttribute('href', '#');
